...
void test_find_index(void)
{
  ...
  s = s && find_index(actual,5);
  show_message("should give success of the value in the list", s);

  s = find_index(actual,3);
  show_message("should give success if value is not present in the list", s);
}
